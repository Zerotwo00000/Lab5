...
"}"));
        ...
        sayLineEdit = new QTextEdit(loginPage);
        sayLineEdit->setObjectName("sayLineEdit");

        horizontalLayout->addWidget(sayLineEdit);

        userListWidget = new QListWidget(loginPage);
